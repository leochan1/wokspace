...
#ifdef _DEBUG
#pragma comment(lib,"../common/log4cplus/lib/log4cplusD.lib")
#else
#pragma comment(lib,"../common/log4cplus/lib/log4cplus.lib")
#endif // _DEBUG
...
public:
	...
	static void initFile(string str)
	{
		...
		p = localtime(&tmp_time);  
		char szDate[100]={0};
		sprintf(szDate, "%d-%d-%d_", p->tm_year+1900, p->tm_mon+1, p->tm_mday); 
